...
output "sg_http_80_id" {
  ...
  value       = module.sg_http_80.this_security_group_id
}

output "sg_http_80_group_vpc_id" {
  description = "The VPC ID"
  value       = module.sg_http_80.this_security_group_vpc_id
}

output "sg_http_80_group_owner_id" {
  description = "The owner ID"
  value       = module.sg_http_80.this_security_group_owner_id
}

output "sg_http_80_group_name" {
  description = "The name of the security group"
  value       = module.sg_http_80.this_security_group_name
}

output "sg_http_80_group_description" {
  description = "The description of the security group"
  value       = module.sg_http_80.this_security_group_description
}
...
output "sg_https_443_id" {
  ...
  value       = module.sg_https_443.this_security_group_id
}

output "sg_https_443_group_vpc_id" {
  description = "The VPC ID"
  value       = module.sg_https_443.this_security_group_vpc_id
}

output "sg_https_443_group_owner_id" {
  description = "The owner ID"
  value       = module.sg_https_443.this_security_group_owner_id
}

output "sg_https_443_group_name" {
  description = "The name of the security group"
  value       = module.sg_https_443.this_security_group_name
}

output "sg_https_443_group_description" {
  description = "The description of the security group"
  value       = module.sg_https_443.this_security_group_description
}
...
output "sg_pihole_id" {
  ...
  value       = module.sg_pihole.this_security_group_id
}

output "sg_pihole_group_vpc_id" {
  description = "The VPC ID"
  value       = module.sg_pihole.this_security_group_vpc_id
}

output "sg_pihole_group_owner_id" {
  description = "The owner ID"
  value       = module.sg_pihole.this_security_group_owner_id
}

output "sg_pihole_group_name" {
  description = "The name of the security group"
  value       = module.sg_pihole.this_security_group_name
}

output "sg_pihole_group_description" {
  description = "The description of the security group"
  value       = module.sg_pihole.this_security_group_description
}
...
output "sg_vpn_group_vpc_id" {
  description = "The VPC ID"
  value       = module.sg_vpn.this_security_group_vpc_id
}

output "sg_vpn_group_owner_id" {
  description = "The owner ID"
  value       = module.sg_vpn.this_security_group_owner_id
}

output "sg_vpn_group_name" {
  description = "The name of the security group"
  value       = module.sg_vpn.this_security_group_name
}

output "sg_vpn_group_description" {
  description = "The description of the security group"
  value       = module.sg_vpn.this_security_group_description
}